...
/**
 * Task 1: basic activity
 * update gradle file
 * create word entity
 * create word dao (data access object)
 * use live data in word dao
 * add room database wordroomdatabase class
 * create class wordrepository
 * create viewModel class
 * add style
 * add item layout as : recyclerview_item.xml
 * add recyler view content_main.xml
 * fix the icon in fab activity_main.xml
 * create adapter WordListAdapter class and add recycler view
 * add recycler view in mainActivity  : Add the RecyclerView in the onCreate() method of MainActivity:
 * populate database in wordroomdatabase calss
 * reate an inner class PopulateDbAsync inside wordroomdatabase to delete files
 * connect ui with data
 * create and activity for adding new words and create layout of new word in that activity xml file
 *
 *
 * */
